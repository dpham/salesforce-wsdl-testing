...
public class PartnerConnection {
  ...
  public void setCallOptions(java.lang.String client,java.lang.String defaultNamespace,java.lang.String clientLog,boolean debugExceptions,java.lang.String platform,java.lang.String remoteApplication) {
    __CallOptions = new com.sforce.soap.partner.CallOptions_element();
       ...
       __CallOptions.setClientLog(clientLog);
       __CallOptions.setDebugExceptions(debugExceptions);
       __CallOptions.setPlatform(platform);
       __CallOptions.setRemoteApplication(remoteApplication);
  }
  ...
  public void setQueryOptions(int batchSize,java.lang.String filterLanguage,com.sforce.soap.partner.QueryOptionsScope scope) {
    __QueryOptions = new com.sforce.soap.partner.QueryOptions_element();
     
       __QueryOptions.setBatchSize(batchSize);
       __QueryOptions.setFilterLanguage(filterLanguage);
       __QueryOptions.setScope(scope);
  }
  ...
  private com.sforce.soap.partner.PartnerNetworkHeader_element __PartnerNetworkHeader;

  public void setPartnerNetworkHeader(java.lang.String connectionId,java.lang.String[] partnerEntityIds,java.lang.String[] parentEntityIds) {
    __PartnerNetworkHeader = new com.sforce.soap.partner.PartnerNetworkHeader_element();
     
       __PartnerNetworkHeader.setConnectionId(connectionId);
       __PartnerNetworkHeader.setPartnerEntityIds(partnerEntityIds);
       __PartnerNetworkHeader.setParentEntityIds(parentEntityIds);
  }

  public void clearPartnerNetworkHeader() {
    __PartnerNetworkHeader = null;
  }

  public com.sforce.soap.partner.PartnerNetworkHeader_element getPartnerNetworkHeader() {
    return  __PartnerNetworkHeader;
  }

  public void __setPartnerNetworkHeader(com.sforce.soap.partner.PartnerNetworkHeader_element __header) {
    __PartnerNetworkHeader = __header ;
  }
  ...
  public void setConditionalRequestHeader(java.util.Calendar ifModifiedBefore,java.util.Calendar ifModifiedSince,java.util.Calendar[] ifModifiedBeforeArray) {
    __ConditionalRequestHeader = new com.sforce.soap.partner.ConditionalRequestHeader_element();
       ...
       __ConditionalRequestHeader.setIfModifiedBeforeArray(ifModifiedBeforeArray);
  }
  ...
  public com.sforce.soap.partner.SyncOfflineDataResult syncOfflineData(boolean reset,boolean userRequested,java.lang.String syncStateId,boolean syncFull,boolean skipNewsFeeds,java.lang.String[] idsToSpider,java.lang.String[] entitiesToSync)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.SyncOfflineData_element __request = new com.sforce.soap.partner.SyncOfflineData_element();
    com.sforce.soap.partner.SyncOfflineDataResponse_element __response = new com.sforce.soap.partner.SyncOfflineDataResponse_element();

  
    __request.setReset(reset);
    __request.setUserRequested(userRequested);
    __request.setSyncStateId(syncStateId);
    __request.setSyncFull(syncFull);
    __request.setSkipNewsFeeds(skipNewsFeeds);
    __request.setIdsToSpider(idsToSpider);
    __request.setEntitiesToSync(entitiesToSync);
    ...
    __response = (com.sforce.soap.partner.SyncOfflineDataResponse_element) __connection.send("",
       syncOfflineData_qname, __request, syncOfflineDataResponse_qname,
       com.sforce.soap.partner.SyncOfflineDataResponse_element.class);
  ...
  public com.sforce.soap.partner.SnapshotResult moreSnapshot(java.lang.String snapshotLocator)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.MoreSnapshot_element __request = new com.sforce.soap.partner.MoreSnapshot_element();
    com.sforce.soap.partner.MoreSnapshotResponse_element __response = new com.sforce.soap.partner.MoreSnapshotResponse_element();

  
    __request.setSnapshotLocator(snapshotLocator);
    ...
    __response = (com.sforce.soap.partner.MoreSnapshotResponse_element) __connection.send("",
       moreSnapshot_qname, __request, moreSnapshotResponse_qname,
       com.sforce.soap.partner.MoreSnapshotResponse_element.class);

    return __response.getResult();
  }
  
  public com.sforce.soap.partner.PerformQuickActionResult[] performQuickAction(com.sforce.soap.partner.PerformQuickActionRequest[] quickActions)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.PerformQuickAction_element __request = new com.sforce.soap.partner.PerformQuickAction_element();
    com.sforce.soap.partner.PerformQuickActionResponse_element __response = new com.sforce.soap.partner.PerformQuickActionResponse_element();
    ...
    __response = (com.sforce.soap.partner.PerformQuickActionResponse_element) __connection.send("",
       performQuickAction_qname, __request, performQuickActionResponse_qname,
       com.sforce.soap.partner.PerformQuickActionResponse_element.class);
  ...
  public com.sforce.soap.partner.DescribeListViewResult[] describeListViews(java.lang.String[] sObjectType)
    ...
    com.sforce.soap.partner.DescribeListViewsResponse_element __response = new com.sforce.soap.partner.DescribeListViewsResponse_element();
    ...
    __response = (com.sforce.soap.partner.DescribeListViewsResponse_element) __connection.send("",
  ...
  public com.sforce.soap.partner.OutlookDescribeResult outlookDescribe()
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.OutlookDescribe_element __request = new com.sforce.soap.partner.OutlookDescribe_element();
    com.sforce.soap.partner.OutlookDescribeResponse_element __response = new com.sforce.soap.partner.OutlookDescribeResponse_element();
    ...
    __response = (com.sforce.soap.partner.OutlookDescribeResponse_element) __connection.send("",
       outlookDescribe_qname, __request, outlookDescribeResponse_qname,
       com.sforce.soap.partner.OutlookDescribeResponse_element.class);
  ...
  public com.sforce.soap.partner.SaveResult[] handleEmailMessage(com.sforce.soap.partner.HandledEmailMessage[] messages)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.HandleEmailMessage_element __request = new com.sforce.soap.partner.HandleEmailMessage_element();
    com.sforce.soap.partner.HandleEmailMessageResponse_element __response = new com.sforce.soap.partner.HandleEmailMessageResponse_element();
    ...
    __response = (com.sforce.soap.partner.HandleEmailMessageResponse_element) __connection.send("",
       handleEmailMessage_qname, __request, handleEmailMessageResponse_qname,
       com.sforce.soap.partner.HandleEmailMessageResponse_element.class);
  ...
  public com.sforce.soap.partner.ImpersonateUserResult[] impersonateUser(java.lang.String[] userIds)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.ImpersonateUser_element __request = new com.sforce.soap.partner.ImpersonateUser_element();
    com.sforce.soap.partner.ImpersonateUserResponse_element __response = new com.sforce.soap.partner.ImpersonateUserResponse_element();

  
    __request.setUserIds(userIds);
    ...
    __response = (com.sforce.soap.partner.ImpersonateUserResponse_element) __connection.send("",
       impersonateUser_qname, __request, impersonateUserResponse_qname,
       com.sforce.soap.partner.ImpersonateUserResponse_element.class);
  ...
  public com.sforce.soap.partner.OutlookSearchResult outlookSearch(java.lang.String searchExpr,java.lang.String contextString)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.OutlookSearch_element __request = new com.sforce.soap.partner.OutlookSearch_element();
    com.sforce.soap.partner.OutlookSearchResponse_element __response = new com.sforce.soap.partner.OutlookSearchResponse_element();

  
    __request.setSearchExpr(searchExpr);
    __request.setContextString(contextString);
    ...
    __response = (com.sforce.soap.partner.OutlookSearchResponse_element) __connection.send("",
       outlookSearch_qname, __request, outlookSearchResponse_qname,
       com.sforce.soap.partner.OutlookSearchResponse_element.class);
  ...
  public com.sforce.soap.partner.SaveResult[] update(com.sforce.soap.partner.sobject.SObject[] sObjects)
    ...
    if (__PartnerNetworkHeader != null) __connection.addHeader(PartnerNetworkHeader_qname, __PartnerNetworkHeader);
  ...
  public com.sforce.soap.partner.SetupBriefcaseResult setupBriefcase()
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.SetupBriefcase_element __request = new com.sforce.soap.partner.SetupBriefcase_element();
    com.sforce.soap.partner.SetupBriefcaseResponse_element __response = new com.sforce.soap.partner.SetupBriefcaseResponse_element();
    ...
    __response = (com.sforce.soap.partner.SetupBriefcaseResponse_element) __connection.send("",
       setupBriefcase_qname, __request, setupBriefcaseResponse_qname,
       com.sforce.soap.partner.SetupBriefcaseResponse_element.class);
  ...
  public com.sforce.soap.partner.LoginResult loginXi(java.lang.String username)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.LoginXi_element __request = new com.sforce.soap.partner.LoginXi_element();
    com.sforce.soap.partner.LoginXiResponse_element __response = new com.sforce.soap.partner.LoginXiResponse_element();
    ...
    __response = (com.sforce.soap.partner.LoginXiResponse_element) __connection.send("",
       loginXi_qname, __request, loginXiResponse_qname,
       com.sforce.soap.partner.LoginXiResponse_element.class);

    return __response.getResult();
  }
  
  public void ackSnapshot(java.lang.String snapshotId)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.AckSnapshot_element __request = new com.sforce.soap.partner.AckSnapshot_element();
    com.sforce.soap.partner.AckSnapshotResponse_element __response = new com.sforce.soap.partner.AckSnapshotResponse_element();

  
    __request.setSnapshotId(snapshotId);
    ...
    __response = (com.sforce.soap.partner.AckSnapshotResponse_element) __connection.send("",
       ackSnapshot_qname, __request, ackSnapshotResponse_qname,
       com.sforce.soap.partner.AckSnapshotResponse_element.class);
  ...
  public com.sforce.soap.partner.DescribeMiniLayoutResult describeMiniLayout(java.lang.String sObjectType,java.lang.String[] recordTypeIds)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.DescribeMiniLayout_element __request = new com.sforce.soap.partner.DescribeMiniLayout_element();
    com.sforce.soap.partner.DescribeMiniLayoutResponse_element __response = new com.sforce.soap.partner.DescribeMiniLayoutResponse_element();
    ...
    __response = (com.sforce.soap.partner.DescribeMiniLayoutResponse_element) __connection.send("",
       describeMiniLayout_qname, __request, describeMiniLayoutResponse_qname,
       com.sforce.soap.partner.DescribeMiniLayoutResponse_element.class);

    return __response.getResult();
  }
  
  public com.sforce.soap.partner.DescribeWorkitemActionResult[] describeWorkitemActions(java.lang.String[] workitemIds)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.DescribeWorkitemActions_element __request = new com.sforce.soap.partner.DescribeWorkitemActions_element();
    com.sforce.soap.partner.DescribeWorkitemActionsResponse_element __response = new com.sforce.soap.partner.DescribeWorkitemActionsResponse_element();
    ...
    __response = (com.sforce.soap.partner.DescribeWorkitemActionsResponse_element) __connection.send("",
       describeWorkitemActions_qname, __request, describeWorkitemActionsResponse_qname,
       com.sforce.soap.partner.DescribeWorkitemActionsResponse_element.class);
  ...
  public java.lang.String[] emailMerge(java.lang.String template,java.lang.String[] id)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.EmailMerge_element __request = new com.sforce.soap.partner.EmailMerge_element();
    com.sforce.soap.partner.EmailMergeResponse_element __response = new com.sforce.soap.partner.EmailMergeResponse_element();

  
    __request.setTemplate(template);
    __request.setId(id);
    ...
    __response = (com.sforce.soap.partner.EmailMergeResponse_element) __connection.send("",
       emailMerge_qname, __request, emailMergeResponse_qname,
       com.sforce.soap.partner.EmailMergeResponse_element.class);

    return __response.getResult();
  }
  
  public void ackSyncOfflineData(java.lang.String token,java.lang.String syncStateId)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.AckSyncOfflineData_element __request = new com.sforce.soap.partner.AckSyncOfflineData_element();
    com.sforce.soap.partner.AckSyncOfflineDataResponse_element __response = new com.sforce.soap.partner.AckSyncOfflineDataResponse_element();

  
    __request.setToken(token);
    __request.setSyncStateId(syncStateId);
    ...
    __response = (com.sforce.soap.partner.AckSyncOfflineDataResponse_element) __connection.send("",
       ackSyncOfflineData_qname, __request, ackSyncOfflineDataResponse_qname,
       com.sforce.soap.partner.AckSyncOfflineDataResponse_element.class);
  ...
  public com.sforce.soap.partner.DescribeLookupLayoutResult[] describeLookupLayouts(java.lang.String[] sObjectType)
    ...
    com.sforce.soap.partner.DescribeLookupLayoutsResponse_element __response = new com.sforce.soap.partner.DescribeLookupLayoutsResponse_element();
    ...
    __response = (com.sforce.soap.partner.DescribeLookupLayoutsResponse_element) __connection.send("",
  ...
  public com.sforce.soap.partner.ActivateResult[] activate(java.lang.String[] ids)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.Activate_element __request = new com.sforce.soap.partner.Activate_element();
    com.sforce.soap.partner.ActivateResponse_element __response = new com.sforce.soap.partner.ActivateResponse_element();
    ...
    __response = (com.sforce.soap.partner.ActivateResponse_element) __connection.send("",
       activate_qname, __request, activateResponse_qname,
       com.sforce.soap.partner.ActivateResponse_element.class);
  ...
  public com.sforce.soap.partner.DescribeMobileResult describeMobile()
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.DescribeMobile_element __request = new com.sforce.soap.partner.DescribeMobile_element();
    com.sforce.soap.partner.DescribeMobileResponse_element __response = new com.sforce.soap.partner.DescribeMobileResponse_element();
    ...
    __response = (com.sforce.soap.partner.DescribeMobileResponse_element) __connection.send("",
       describeMobile_qname, __request, describeMobileResponse_qname,
       com.sforce.soap.partner.DescribeMobileResponse_element.class);

    return __response.getResult();
  }
  
  public com.sforce.soap.partner.SnapshotResult createSnapshot(java.lang.String sObject,boolean forceFullSnapshot)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.CreateSnapshot_element __request = new com.sforce.soap.partner.CreateSnapshot_element();
    com.sforce.soap.partner.CreateSnapshotResponse_element __response = new com.sforce.soap.partner.CreateSnapshotResponse_element();

  
    __request.setSObject(sObject);
    __request.setForceFullSnapshot(forceFullSnapshot);
    ...
    __response = (com.sforce.soap.partner.CreateSnapshotResponse_element) __connection.send("",
       createSnapshot_qname, __request, createSnapshotResponse_qname,
       com.sforce.soap.partner.CreateSnapshotResponse_element.class);

    return __response.getResult();
  }
  
  public com.sforce.soap.partner.DescribeQuickActionResult[] describeQuickAction(java.lang.String[] quickActions)
       throws com.sforce.ws.ConnectionException {
    com.sforce.ws.transport.SoapConnection __connection = newConnection();
    com.sforce.soap.partner.DescribeQuickAction_element __request = new com.sforce.soap.partner.DescribeQuickAction_element();
    com.sforce.soap.partner.DescribeQuickActionResponse_element __response = new com.sforce.soap.partner.DescribeQuickActionResponse_element();
    ...
    __response = (com.sforce.soap.partner.DescribeQuickActionResponse_element) __connection.send("",
       describeQuickAction_qname, __request, describeQuickActionResponse_qname,
       com.sforce.soap.partner.DescribeQuickActionResponse_element.class);
  ...
  public void addExtraHeader(QName __headerName, XMLizable __value) {
	...
	}    private static final javax.xml.namespace.QName syncOfflineData_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "syncOfflineData");
    private static final javax.xml.namespace.QName syncOfflineDataResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "syncOfflineDataResponse");
    ...
    private static final javax.xml.namespace.QName moreSnapshot_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "moreSnapshot");
    private static final javax.xml.namespace.QName moreSnapshotResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "moreSnapshotResponse");
    private static final javax.xml.namespace.QName performQuickAction_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "performQuickAction");
    private static final javax.xml.namespace.QName performQuickActionResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "performQuickActionResponse");
    ...
    private static final javax.xml.namespace.QName outlookDescribe_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "outlookDescribe");
    private static final javax.xml.namespace.QName outlookDescribeResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "outlookDescribeResponse");
    ...
    private static final javax.xml.namespace.QName handleEmailMessage_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "handleEmailMessage");
    private static final javax.xml.namespace.QName handleEmailMessageResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "handleEmailMessageResponse");
    ...
    private static final javax.xml.namespace.QName impersonateUser_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "impersonateUser");
    private static final javax.xml.namespace.QName impersonateUserResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "impersonateUserResponse");
    ...
    private static final javax.xml.namespace.QName outlookSearch_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "outlookSearch");
    private static final javax.xml.namespace.QName outlookSearchResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "outlookSearchResponse");
    ...
    private static final javax.xml.namespace.QName setupBriefcase_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "setupBriefcase");
    private static final javax.xml.namespace.QName setupBriefcaseResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "setupBriefcaseResponse");
    ...
    private static final javax.xml.namespace.QName loginXi_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "loginXi");
    private static final javax.xml.namespace.QName loginXiResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "loginXiResponse");
    private static final javax.xml.namespace.QName ackSnapshot_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "ackSnapshot");
    private static final javax.xml.namespace.QName ackSnapshotResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "ackSnapshotResponse");
    ...
    private static final javax.xml.namespace.QName describeMiniLayout_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeMiniLayout");
    private static final javax.xml.namespace.QName describeMiniLayoutResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeMiniLayoutResponse");
    private static final javax.xml.namespace.QName describeWorkitemActions_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeWorkitemActions");
    private static final javax.xml.namespace.QName describeWorkitemActionsResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeWorkitemActionsResponse");
    ...
    private static final javax.xml.namespace.QName emailMerge_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "emailMerge");
    private static final javax.xml.namespace.QName emailMergeResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "emailMergeResponse");
    private static final javax.xml.namespace.QName ackSyncOfflineData_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "ackSyncOfflineData");
    private static final javax.xml.namespace.QName ackSyncOfflineDataResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "ackSyncOfflineDataResponse");
    ...
    private static final javax.xml.namespace.QName activate_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "activate");
    private static final javax.xml.namespace.QName activateResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "activateResponse");
    ...
    private static final javax.xml.namespace.QName describeMobile_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeMobile");
    private static final javax.xml.namespace.QName describeMobileResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeMobileResponse");
    private static final javax.xml.namespace.QName createSnapshot_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "createSnapshot");
    private static final javax.xml.namespace.QName createSnapshotResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "createSnapshotResponse");
    private static final javax.xml.namespace.QName describeQuickAction_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeQuickAction");
    private static final javax.xml.namespace.QName describeQuickActionResponse_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "describeQuickActionResponse");
    ...
    private static final javax.xml.namespace.QName PartnerNetworkHeader_qname = new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "PartnerNetworkHeader");
  ...
  knownHeaders.put(PartnerNetworkHeader_qname,com.sforce.soap.partner.PartnerNetworkHeader_element.class);
