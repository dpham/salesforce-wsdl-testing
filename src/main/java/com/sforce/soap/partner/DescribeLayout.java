...
public class DescribeLayout implements com.sforce.ws.bind.XMLizable {
  ...
  public void setMultirowEditLayoutSections(com.sforce.soap.partner.DescribeLayoutSection[] multirowEditLayoutSections) {
    this.multirowEditLayoutSections = multirowEditLayoutSections;
    multirowEditLayoutSections__is_set = true;
  }
  
  /**
   * element  : offlineLinks of type {urn:partner.soap.sforce.com}OfflineLink
   * java type: com.sforce.soap.partner.OfflineLink[]
   */
  private static final com.sforce.ws.bind.TypeInfo offlineLinks__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","offlineLinks","urn:partner.soap.sforce.com","OfflineLink",0,-1,true);

  private boolean offlineLinks__is_set = false;

  private com.sforce.soap.partner.OfflineLink[] offlineLinks = new com.sforce.soap.partner.OfflineLink[0];

  public com.sforce.soap.partner.OfflineLink[] getOfflineLinks() {
    return offlineLinks;
  }

  

  public void setOfflineLinks(com.sforce.soap.partner.OfflineLink[] offlineLinks) {
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
    ...
    __typeMapper.writeObject(__out, offlineLinks__typeInfo, offlineLinks, offlineLinks__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, offlineLinks__typeInfo)) {
      setOfflineLinks((com.sforce.soap.partner.OfflineLink[])__typeMapper.readObject(__in, offlineLinks__typeInfo, com.sforce.soap.partner.OfflineLink[].class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(multirowEditLayoutSections)+"'\n");
    sb.append(" offlineLinks=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(offlineLinks)+"'\n");
