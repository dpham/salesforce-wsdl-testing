...
public class DescribeSObjectResult implements com.sforce.ws.bind.XMLizable {
   ...
   * java type: boolean
   */
  private static final com.sforce.ws.bind.TypeInfo listviewable__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","listviewable","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);
   ...
   * java type: boolean
   */
  private static final com.sforce.ws.bind.TypeInfo lookupLayoutable__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:partner.soap.sforce.com","lookupLayoutable","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
    ...
    __typeMapper.writeBoolean(__out, listviewable__typeInfo, listviewable, listviewable__is_set);
    __typeMapper.writeBoolean(__out, lookupLayoutable__typeInfo, lookupLayoutable, lookupLayoutable__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, listviewable__typeInfo)) {
      setListviewable((boolean)__typeMapper.readBoolean(__in, listviewable__typeInfo, boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, lookupLayoutable__typeInfo)) {
      setLookupLayoutable((boolean)__typeMapper.readBoolean(__in, lookupLayoutable__typeInfo, boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(listviewable)+"'\n");
    sb.append(" lookupLayoutable=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(lookupLayoutable)+"'\n");
    sb.append(" mergeable=");
